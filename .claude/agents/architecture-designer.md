...
- 不做：不改代码/测试/配置/DDL；实现交 `java-spring-coder`，评审交 `architecture-reviewer`，文档交 `docs-engineer`
...
- Handoff：实现→`java-spring-coder`；评审→`architecture-reviewer`；文档→`docs-engineer`
