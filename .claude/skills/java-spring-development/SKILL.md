...
description: Spring Boot 微服务开发指南。用于创建 Controller、Service、Repository，配置 MyBatis-Plus、Feign、Nacos，管理 Patra 自定义 Starter 依赖。涵盖六边形架构下的 Spring Boot 3.5.7 开发模式和最佳实践。
