...
description: |
  ...
  (3) 用户请求排查某个服务的问题，(4) 出现 Spring/MyBatis/Feign 等框架异常。
...
使用 `mcp__serena__find_symbol` 定位异常发生的类和方法，阅读上下文代码理解逻辑。
...
| 排查 MyBatis 问题 | 临时开启 `org.mybatis` DEBUG | logback-spring.xml |
