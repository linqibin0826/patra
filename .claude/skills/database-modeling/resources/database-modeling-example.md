...
> **📖 通用规范引用**
>
> - **技术栈约束**: Patra 项目统一使用 MySQL 8.0+、MyBatis-Plus 3.5.x、Spring Boot 3.5.7
> - **审计字段规范**: 所有业务表必须包含标准审计字段，详见 [standard-audit-fields.sql](standard-audit-fields.sql)
> - **索引设计原则**: 索引选择性要求和软删除字段策略，详见 [index-optimization-guide.md](index-optimization-guide.md)
...
**审计字段:** (参见 [standard-audit-fields.sql](standard-audit-fields.sql))
