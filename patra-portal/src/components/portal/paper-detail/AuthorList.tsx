        ...
        >
          ...
          <span className="flex min-w-0 flex-col gap-0.5">
            <span className="font-sans text-md font-semibold text-ink-900">
              {a.name}
              {a.first && (
                <span className="ml-2 rounded-sm border border-border-default bg-paper-200 px-1.5 py-px align-middle font-sans text-3xs font-semibold text-fg-3">
                  第一作者
                </span>
              )}
              {a.corresponding && (
                <span className="ml-2 rounded-sm border border-clay-200 bg-clay-50 px-1.5 py-px align-middle font-sans text-3xs font-semibold text-clay-800">
