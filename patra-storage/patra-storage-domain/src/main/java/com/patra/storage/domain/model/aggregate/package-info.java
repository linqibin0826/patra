 ...
 * Storage 领域模型聚合根包。
 *
 * <p>本包包含 patra-storage 服务的聚合根实体,作为六边形架构领域层的核心组件。 聚合根封装了业务逻辑和不变性规则,是领域模型的入口点,所有外部操作都必须通过聚合根进行。
 *
 * <h2>核心聚合根</h2>
 *
 * <ul>
 *   <li>{@link com.patra.storage.domain.model.aggregate.FileMetadata} - 文件元数据聚合根,
