 ...
 * Maps to patra.egress.resilience configuration
 * Contains maximum values and default values for resilience settings
 *
 * @author linqibin
 * @since 0.1.0
 */
...
public class ResilienceProperties {
    ...
    /**
     * Maximum values for resilience configuration
     * These are upper bounds that caller configurations cannot exceed
     */
     ...
     * Used when caller does not provide configuration
     */
    @NestedConfigurationProperty
