...
public record ResilienceConfig(
  ...
  public ResilienceConfig {
    ...
    responseHeaderWhitelist =
        responseHeaderWhitelist != null ? List.copyOf(responseHeaderWhitelist) : List.of();
  }
  ...
  public void validate() {
    ...
    if (circuitBreakerWindow == null
        || circuitBreakerWindow.isNegative()
        || circuitBreakerWindow.isZero()) {
