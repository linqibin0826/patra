...
class ExternalCallControllerTest {
    ...
    @MockBean
    private ExternalCallUseCase externalCallUseCase;
    ...
    void shouldCallExternalServiceSuccessfully() throws Exception {
        ...
        // When & Then
        mockMvc.perform(post("/api/egress/call")
    ...
    void shouldReturnBadRequestWhenUrlIsBlank() throws Exception {
        ...
        // When & Then - In unit test environment without full error handling, we only verify status code
        mockMvc.perform(post("/api/egress/call")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
    ...
    void shouldReturnBadRequestWhenResilienceConfigIsInvalid() throws Exception {
        ...
        ResilienceConfigDTO invalidConfig = new ResilienceConfigDTO(
    ...
    void shouldIncludeRateLimitStatusInResponse() throws Exception {
        ...
        ExternalRateLimitInfo externalInfo = new ExternalRateLimitInfo(
                1000,
                950,
    ...
    void shouldAcceptRequestWithCustomResilienceConfig() throws Exception {
        ...
        ResilienceConfigDTO config = new ResilienceConfigDTO(
                ...
                5,
                30L,
                List.of("Content-Type", "X-Custom-Header")
        );
