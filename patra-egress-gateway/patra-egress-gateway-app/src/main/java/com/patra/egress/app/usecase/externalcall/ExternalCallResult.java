...
/**
 * External call result Contains response envelope, duration, retry count, and trace ID
 *
...
public record ExternalCallResult(
    ResponseEnvelope envelope, Duration duration, int retryCount, String traceId) {
