...
class ExprCapabilityQueryTest {
    ...
    class ConstructorValidationTest {
        ...
        void shouldCreateInstanceWithValidParameters() {
            ...
            // When
            ExprCapabilityQuery query = new ExprCapabilityQuery(
                provenanceId,
                "SEARCH",
                fieldKey,
                "[\"eq\", \"ne\"]",
    ...
    class FieldTrimTest {
        ...
        void shouldTrimRangeKindCode() {
            ...
            // When
            ExprCapabilityQuery query = createMinimalQuery(1L, "field.key", rangeKindCodeWithSpaces, Instant.now());
        ...
        void shouldTrimTermPatternWhenNotNull() {
            ...
            ExprCapabilityQuery query = new ExprCapabilityQuery(
                1L, null, "field.key",
                null, null, false, null, false, false,
                0, 0, termPatternWithSpaces, 0, false,
                "DATE",
                false, false, false,
                null, null, null, null, null, null,
                false, null, null,
        ...
        void shouldTrimTokenValuePatternWhenNotNull() {
            ...
            ExprCapabilityQuery query = new ExprCapabilityQuery(
                ...
                false, false, false,
                null, null, null, null, null, null,
                false, null, tokenValuePatternWithSpaces,
                Instant.now(),
                null
            );
    ...
    class RecordSemanticsTest {
        ...
        void shouldNotBeEqualForDifferentEffectiveFrom() {
            // Given
            ExprCapabilityQuery query1 = createMinimalQuery(1L, "field.key", "DATE", Instant.parse("2024-01-01T00:00:00Z"));
            ExprCapabilityQuery query2 = createMinimalQuery(1L, "field.key", "DATE", Instant.parse("2024-01-02T00:00:00Z"));
        ...
        void shouldIncludeAllFieldsInToString() {
            // Given
            ExprCapabilityQuery query = createMinimalQuery(1L, "author.name", "DATE", Instant.parse("2024-01-01T00:00:00Z"));
    ...
    class BoundaryConditionTest {
        ...
        void shouldAcceptMaxLongAsProvenanceId() {
            ...
            // When
            ExprCapabilityQuery query = createMinimalQuery(maxProvenanceId, "field.key", "DATE", Instant.now());
        ...
        void shouldAcceptNullDateMin() {
            ...
            ExprCapabilityQuery query = new ExprCapabilityQuery(
                ...
                "DATE",
                false, false, false,
                dateMin, null, null, null, null, null,
                false, null, null,
                Instant.now(),
                null
            );
        ...
        void shouldAcceptZeroAsBigDecimalNumberMin() {
            ...
            ExprCapabilityQuery query = new ExprCapabilityQuery(
                ...
                "DATE",
                false, false, false,
                null, null, null, null, numberMin, null,
                false, null, null,
                Instant.now(),
                null
            );
