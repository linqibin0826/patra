 ...
 *
 * <p>Represents the root provenance entity referenced by all reg_prov_* configurations.
 * This serves as the catalog basic information for external data sources (e.g., PubMed, Crossref).</p>
 *
 * @author linqibin
 * @since 0.1.0
 */
