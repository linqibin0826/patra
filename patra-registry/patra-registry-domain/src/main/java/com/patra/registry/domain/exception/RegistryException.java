 ...
 *
 * <p>Represents business rule violations inside the Registry domain and is intended
 * to be handled uniformly by the application layer. All Registry domain
 * exceptions shall extend this class for consistency.</p>
 *
 * @author linqibin
 * @since 0.1.0
 */
