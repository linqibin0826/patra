...
VALUES
    (1, 1, 'ALL', '2025-09-01 00:00:00.000000', NULL,
     ...
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0, INET6_ATON('192.168.1.20'), NULL);
...
(id, field_key, display_name, description, data_type_code, cardinality_code,
 ...
 created_at, created_by, created_by_name, updated_at, updated_by, updated_by_name, deleted_at)
VALUES
    ...
    (900001, 'entrez_date', 'Entrez Date', 'PubMed Entrez date for temporal filtering',
     ...
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', NULL),
