 ...
 * Scope:
 *  - reg_expr_field_dict: add unified field 'publication_date'
 *  - reg_prov_expr_capability: declare RANGE capability for publication_date
...
VALUES
    (900001,
     'publication_date',
     'Publication Date',
     'Unified publication date across sources; used for time-window filtering',
     'DATE', 'SINGLE', 1, 1,
...
VALUES
    (900101, 1, 'ALL', 'ACTIVE',
     ...
     0, NULL, NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','PubMed: publication_date supports RANGE[DATE]')),
     0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0);
...
VALUES
    (900102, 1, 'ALL', 'ACTIVE',
     ...
     0, NULL, NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','PubMed: tiab supports TERM/IN; NOT allowed for TERM')),
     0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0);


-- 3) Render rule for publication_date RANGE -> standard params
...
VALUES
    (900201, 1, 'ALL', 'ACTIVE',
     ...
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','Emit std params for PubMed date filtering')),
     0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0);
...
VALUES
    (900202, 1, 'ALL', 'ACTIVE',
     ...
     '{{v}}[TIAB]', NULL, NULL, 0,
     NULL, NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','TERM template for TIAB: ANY match (no quotes)')),
     0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0);
...
VALUES
    (900204, 1, 'ALL', 'ACTIVE',
     ...
     '"{{v}}"[TIAB]', NULL, NULL, 0,
     NULL, NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','TERM template for TIAB: PHRASE match (quoted)')),
     0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0);
...
VALUES
    (900203, 1, 'ALL', 'ACTIVE',
     ...
     NULL, '"{{item}}"[TIAB]', ' OR ', 1,
     NULL, NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','IN template for TIAB: OR-joined quoted items with wrap')),
     0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0);
...
VALUES
    ...
    (900301, 1, 'ALL', 'ACTIVE',
     ...
     TIMESTAMP('2025-10-14 00:00:00.000000'), NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','std from -> mindate')), 0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0),
    ...
    (900302, 1, 'ALL', 'ACTIVE',
     ...
     TIMESTAMP('2025-10-14 00:00:00.000000'), NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','std to -> maxdate (exclusive minus 1 day)')), 0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0),
    ...
    (900303, 1, 'ALL', 'ACTIVE',
     ...
     TIMESTAMP('2025-10-14 00:00:00.000000'), NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','std datetype -> datetype')), 0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0),
    ...
    (900304, 1, 'ALL', 'ACTIVE',
     ...
     TIMESTAMP('2025-10-14 00:00:00.000000'), NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','std limit -> retmax')), 0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0),
    ...
    (900305, 1, 'ALL', 'ACTIVE',
     ...
     TIMESTAMP('2025-10-14 00:00:00.000000'), NULL,
     JSON_ARRAY(JSON_OBJECT('time','2025-10-14 00:00:00','by','系统管理员','note','std offset -> retstart')), 0, INET6_ATON('0.0.0.0'),
     NOW(6), 1001, '系统管理员', NOW(6), 1001, '系统管理员', 0);
