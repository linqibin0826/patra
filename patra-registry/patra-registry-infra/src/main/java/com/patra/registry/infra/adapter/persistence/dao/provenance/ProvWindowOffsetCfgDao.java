...
/// 窗口偏移配置 JPA Repository。
///
/// **职责**：
///
/// - 提供 ProvWindowOffsetCfgEntity 的 CRUD 操作
/// - 支持时态切片和操作优先级查询
///
/// @author linqibin
/// @since 0.1.0
public interface ProvWindowOffsetCfgDao extends JpaRepository<ProvWindowOffsetCfgEntity, Long> {

  /// 查询指定数据源和操作作用域的有效窗口偏移配置。
  ///
  ...
  @Query(
      value =
          ...
          """,
      nativeQuery = true)
  Optional<ProvWindowOffsetCfgEntity> findActiveMerged(
