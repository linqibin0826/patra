 ...
 *
 * <p>Provides query utilities for linking external alias codes to internal dictionary items.
 *
 * <p>SQL definitions live in {@code resources/mapper/RegSysDictItemAliasMapper.xml}.
 *
 * @author linqibin
 * @since 0.1.0
 */
