...
/**
 * Read-only mapper for {@code sys_dict_item_alias}.
 * <p>Provides query utilities for linking external alias codes to internal dictionary items.</p>
 *
 * <p>SQL definitions live in {@code resources/mapper/RegSysDictItemAliasMapper.xml}.</p>
 *
 * @author linqibin
 * @since 0.1.0
 */
