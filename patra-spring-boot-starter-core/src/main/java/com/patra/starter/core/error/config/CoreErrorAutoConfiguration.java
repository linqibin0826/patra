 ...
 *
 * <p>Provides default engine, interceptors, and observation beans which can be overridden by
 * applications.
 */
@Slf4j
@Configuration
...
public class CoreErrorAutoConfiguration {
  ...
  public ErrorResolutionEngine errorResolutionEngine(
    ...
    if (errorProperties.getContextPrefix() == null
      ...
      log.warn(
          "patra.error.context-prefix is not configured; using UNKNOWN as the unified error prefix");
    }
