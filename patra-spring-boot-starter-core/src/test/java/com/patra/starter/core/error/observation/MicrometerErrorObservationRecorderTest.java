...
class MicrometerErrorObservationRecorderTest {
    ...
    void recordResolution_shouldRecordDurationCountersAndSlowMetric() {
        ...
        MicrometerErrorObservationRecorder recorder = new MicrometerErrorObservationRecorder(registry, props);
        ...
        Timer timer = registry.find("papertrace.error.resolution.duration")
        ...
        Counter counter = registry.find("papertrace.error.resolution.count")
                .tags("context", "ING", "errorCode", "ING-0400")
                .counter();
        assertThat(counter).isNotNull();
        assertThat(counter.count()).isEqualTo(1.0d);

        Counter slow = registry.find("papertrace.error.resolution.slow")
    ...
    void recordCircuitBreakerFallback_shouldFallbackToUnknownContextAndNullException() {
        ...
        Counter fallback = registry.find("papertrace.error.resolution.circuit_breaker")
