 ...
 * <p>提供可观测性三大支柱的配置：
 * <ul>
 *   <li>Metrics（指标）：指标收集、导出、命名规范</li>
 *   <li>Tracing（追踪）：分布式追踪、采样率、Baggage 传播</li>
 *   <li>Logging（日志）：日志关联、TraceID 包含、日志格式</li>
 * </ul>
 *
 * <p>安全特性：
 * <ul>
 *   <li>敏感数据脱敏：生产环境强制启用</li>
 *   <li>Actuator 访问控制：保护可观测性端点</li>
 * </ul>
 *
 * @author Jobs
 * @since 1.0.0
...
public class ObservabilityProperties {
    ...
    public static class TracingConfig {
         ...
         * 追踪 Header 名称。
         */
        private List<String> headerNames = List.of(
            "X-Trace-ID",
            "X-B3-TraceId",
            "traceparent"
        );
