...
class ExprJsonCodecTest {
  ...
  void roundTrip_complex() {
    Expr expr =
        Exprs.and(
            List.of(
                ...
                Exprs.rangeNumber(
                    "score", new BigDecimal("0.8"), new BigDecimal("0.95"), true, false),
    ...
    // Serialize again to verify structural stability.
  ...
  void rangeVariants() {
    ...
    Expr dt =
        Exprs.rangeDateTime(
            "dt", Instant.parse("2024-01-01T00:00:00Z"), Instant.parse("2024-01-02T00:00:00Z"));
