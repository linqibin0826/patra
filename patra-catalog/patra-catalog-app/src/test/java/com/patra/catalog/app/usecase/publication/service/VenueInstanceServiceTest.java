...
/// VenueInstanceService 单元测试。
///
/// @author linqibin
/// @since 0.1.0
@DisplayName("VenueInstanceService")
@ExtendWith(MockitoExtension.class)
class VenueInstanceServiceTest {

  @Mock private VenueInstanceRepository venueInstanceRepository;

  @InjectMocks private VenueInstanceService venueInstanceService;
  ...
  class FindOrCreateJournalInstanceTest {
    ...
    void should_return_existing_instance_when_found() {
      ...
      // when
      VenueInstanceAggregate result =
          venueInstanceService.findOrCreateJournalInstance(
              VENUE_ID, VOLUME, ISSUE, YEAR, MONTH, DAY);
    ...
    void should_work_when_volume_and_issue_are_null() {
      ...
      // when
      VenueInstanceAggregate result =
          venueInstanceService.findOrCreateJournalInstance(VENUE_ID, null, null, YEAR, null, null);
