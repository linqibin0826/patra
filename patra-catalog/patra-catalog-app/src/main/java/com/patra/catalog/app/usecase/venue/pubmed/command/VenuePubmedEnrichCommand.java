...
/// @author linqibin
/// @since 0.1.0
public record VenuePubmedEnrichCommand(String url, String lsiouVersion)
  ...
  public static VenuePubmedEnrichCommand of(String url, String lsiouVersion) {
    return new VenuePubmedEnrichCommand(url, lsiouVersion);
  }
