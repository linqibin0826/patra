 ...
 *
 * <ul>
 *   <li><b>GOLD</b> - 黄金 OA（出版商开放，最佳）
 *   <li><b>GREEN</b> - 绿色 OA（机构仓储，次佳）
 *   <li><b>HYBRID</b> - 混合 OA（部分开放）
 *   <li><b>BRONZE</b> - 青铜 OA（免费但无许可证）
 *   <li><b>CLOSED</b> - 封闭获取
 * </ul>
 *
 * <p>业务规则：
 *
 * <ul>
 *   <li>一个文献可能有多个 OA 位置，选择优先级最高的状态
 *   <li>GOLD > GREEN > HYBRID > BRONZE > CLOSED
 *   <li>用于快速筛选 OA 文献（WHERE oa_status != 'closed'）
 * </ul>
 *
 * <p>使用示例：
 *
