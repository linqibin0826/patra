 ...
 *
 * <ol>
 *   <li><b>优先级 1</b>：ROR ID(准确率 99%,覆盖率 60%)
 *   <li><b>优先级 2</b>：GRID ID(准确率 95%,覆盖率 75%)
 *   <li><b>优先级 3</b>：MD5(名称+国家+城市)(准确率 85%,覆盖率 90%)
 *   <li><b>优先级 4</b>：MD5(名称+国家)(准确率 70%,覆盖率 100%)
 * </ol>
 *
 * <p><b>设计说明</b>：
 *
 * <ul>
 *   <li>Affiliation 和 Author 是独立的聚合根
 *   <li>机构-作者关联通过 Repository 管理(不在聚合内)
 *   <li>parent_affiliation 是文本字段,不关联 Affiliation 聚合
 *   <li>去重键由应用层计算并设置
 *   <li>机构层次结构(department/division/section)在聚合内管理
 * </ul>
 *
 * <p><b>业务规则</b>：
 *
 * <ul>
 *   <li>ROR ID 是最可靠的去重标识符
 *   <li>GRID ID 已合并到 ROR,但历史数据仍保留
 *   <li>机构名称应标准化(应用层职责)
 * </ul>
 *
 * @author linqibin
