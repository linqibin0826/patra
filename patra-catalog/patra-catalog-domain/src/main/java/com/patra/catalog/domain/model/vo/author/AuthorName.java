 ...
 * <ul>
 *   <li>不可变性：Record 自动提供
 *   <li>完整性：支持西方姓名结构(Last Name + First Name + Initials + Suffix)
 *   <li>灵活性：所有字段可选(支持不完整姓名)
 *   <li>去重支持：提供标准化姓名用于去重
 * </ul>
 *
 * <p>姓名结构说明：
 *
 * <ul>
 *   <li><b>Last Name</b>：姓氏,如 "Smith", "李"
 *   <li><b>Fore Name</b>：名字,如 "John", "明"
 *   <li><b>Initials</b>：姓名缩写,如 "J.K.", "M."
 *   <li><b>Suffix</b>：后缀,如 "Jr.", "III", "PhD", "MD"
 * </ul>
 *
 * <p>使用示例：
 *
...
public record AuthorName(
   ...
   * 获取完整姓名(西方格式)。
   *
   * <p>格式：First Name Last Name, Suffix
   *
   * <p>示例："John Smith, Jr."
   *
   * @return 完整姓名
   ...
   * 获取简短格式姓名(学术引用格式)。
   *
   * <p>格式：Last Name, Initials Suffix
   *
   * <p>示例："Smith, J. Jr." 或 "Smith, J.K."
   *
   * @return 简短格式姓名
   */
