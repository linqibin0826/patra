 ...
 *
 * <ul>
 *   <li>树形结构：采用层次编号系统(如 C04.557.337.428)
 *   <li>多位置：一个主题词可以有多个树形位置(平均 2.3 个)
 *   <li>层级深度：最多 10 层
 *   <li>示例：
 *       <ul>
 *         <li>C04.557.337.428 - "Lung Neoplasms"(肺肿瘤)
 *         <li>C08.381.540 - "Lung Neoplasms"(同一主题词的另一个位置)
 *       </ul>
 * </ul>
 *
 * <p>业务规则：
 *
 * <ul>
 *   <li>同一主题词的不同树形位置表示不同的语义分类角度
 *   <li>is_primary 标记主要位置(检索时优先)
 *   <li>tree_level 通过点号分隔数自动计算
 *   <li>支持层次查询(如查询 C04 分支下的所有主题词)
 * </ul>
 *
 * <p>使用示例：
 *
...
public class MeshTreeNumber implements Serializable {
  ...
  public String toString() {
    return String.format(
        "MeshTreeNumber[treeNumber=%s, level=%d, primary=%b]",
        treeNumber,
        treeLevel,
        isPrimary);
  }
