...
import com.patra.catalog.infra.adapter.persistence.dao.PublicationAuthorAffiliationDao;
import com.patra.catalog.infra.adapter.persistence.entity.PublicationAuthorAffiliationEntity;
...
/// 作者-机构归属 Dao 集成测试。
///
/// 使用 Testcontainers + MySQL 8 测试 JPA Repository 的 CRUD 操作。
///
/// **测试策略**：
///
/// - 集成测试：使用真实 MySQL 数据库
