...
// MeSH 批次详情仓储实现（规划中）
///       - {@link com.patra.catalog.infra.persistence.repository.MeshDescriptorRepositoryImpl} -
// MeSH 主题词仓储实现
...
///     MeshImportAggregate toDomain(MeshImportTaskDO taskDO, List<MeshTableProgressDO>
// progressDOList);
///
///     // 领域对象 → DO
