...
/**
 * 出版载体数据库实体,映射到表 {@code cat_venue}。
 *
 * <p>表结构: 管理期刊、书籍、会议等出版载体的基本信息(不包含具体卷期)。
 *
 * <p>关键字段说明:
 *
 * <ul>
 *   <li>{@code venue_type} 载体类型,支持 JOURNAL/BOOK/CONFERENCE/OTHER
 *   <li>{@code issn} 期刊专用,唯一索引 idx_issn
 *   <li>{@code isbn} 书籍专用,唯一索引 idx_isbn
 *   <li>{@code issn_type} ISSN 类型,print/electronic
 *   <li>{@code venue_specific_data} JSON 扩展数据字段
 * </ul>
 *
 * @author linqibin
 * @since 0.1.0
