...
/**
 * 人物主题数据库实体,映射到表 {@code cat_personal_name_subject}。
 *
 * <p>表结构: 存储文献的主题人物信息（传记类、历史类、纪念类文献）。
 *
 * <p>关键字段说明:
 *
 * <ul>
 *   <li>{@code publication_id} 出版物ID,外键 cat_publication.id
 *   <li>{@code subject_type} 主题类型（如"biography","history","memorial"）
 *   <li>{@code identifier} 人物标识符（如 VIAF ID, Wikidata ID）
