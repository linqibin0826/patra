...
-- 创建日期: 2025-01-18
-- 设计范围: patra_catalog 分类与索引表(13张表)
-- 作者: Patra Lin
-- MySQL 版本: 8.0+
...
--   6. cat_mesh_entry_combination (组合条目表) - 依赖 cat_mesh_descriptor
--   7. cat_publication_mesh (文献-MeSH关联表) - 依赖 cat_publication, cat_mesh_descriptor, cat_mesh_qualifier
--
-- 关键词体系 (2张表):
--   8. cat_keyword (关键词表) - 无依赖
--   9. cat_publication_keyword (文献-关键词关联表) - 依赖 cat_publication, cat_keyword
--
-- 出版类型 (2张表):
--  10. cat_publication_type (出版类型表) - 无依赖(支持自引用)
--  11. cat_publication_type_mapping (文献-类型关联表) - 依赖 cat_publication, cat_publication_type
--
-- 物质索引 (2张表):
--  12. cat_substance (物质表) - 无依赖
--  13. cat_publication_substance (文献-物质关联表) - 依赖 cat_publication, cat_substance
-- ============================================================
...
-- ============================================================
-- 表 6: cat_mesh_entry_combination (MeSH 组合条目表)
-- ============================================================
-- 表说明: 存储 MeSH 主题词的组合条目信息(EntryCombinationList)
-- 记录数预估: 初始 500 / 5年规模 600
-- 主要查询场景:
--   1. 按 descriptor_id 查询某主题词的所有组合条目(低频)
...
CREATE TABLE IF NOT EXISTS `cat_mesh_entry_combination` (
    ...
    -- 普通索引
    INDEX `idx_descriptor` (`descriptor_id`) COMMENT '主题词索引,支持查询某主题词的所有组合条目',
...
-- ============================================================
-- 表 7: cat_publication_mesh (文献-MeSH 关联表)
-- ============================================================
...
-- ============================================================
-- 表 9: cat_publication_keyword (文献-关键词关联表)
-- ============================================================
...
-- ============================================================
-- 表 10: cat_publication_type (出版类型表)
-- ============================================================
...
-- ============================================================
-- 表 11: cat_publication_type_mapping (文献-类型关联表)
-- ============================================================
...
-- ============================================================
-- 表 13: cat_publication_substance (文献-物质关联表)
-- ============================================================
