...
public final class LayerDependencyRules {
   ...
   * </ul>
   *
   * <p><b>注意：</b>使用精确的包名（..catalog.boot..）避免匹配 Spring Boot 框架包。
   */
   ...
   *
   * <ul>
   *   <li>com.patra.catalog.app.usecase → com.patra.catalog.app.outbox → com.patra.catalog.app.usecase
   *   <li>com.patra.catalog.domain.model → com.patra.catalog.domain.port →
