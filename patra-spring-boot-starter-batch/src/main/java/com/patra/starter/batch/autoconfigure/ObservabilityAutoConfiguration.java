 ...
 *
 * <p>自动配置 Spring Batch Job 监听器，提供基础日志记录能力。
 *
 * <ul>
 *   <li>日志记录：{@link LoggingJobListener}（基础设施层调试工具）
 * </ul>
 *
 * <p>注意: 指标收集和追踪集成功能已移至 patra-spring-boot-starter-observability，
 * 通过扩展点机制提供，符合关注点分离原则。
 *
...
public class ObservabilityAutoConfiguration {
   ...
   *
   * <p>注意：日志监听器不属于可观测性范畴，而是基础设施层的调试工具，因此保留在本模块中。
