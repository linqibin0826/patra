...
(
  ...
  -- 字典以编码关联：scope/window_mode/window_size_unit/lookback_unit/overlap_unit/offset_type/lifecycle_status 使用 sys_dict_item.item_code
...
(
  ...
  -- 字典以编码关联：scope/pagination_mode/lifecycle_status 使用 sys_dict_item.item_code
...
(
  ...
  -- 字典以编码关联：scope/retry_after_policy/lifecycle_status 使用 sys_dict_item.item_code
...
(
  ...
  -- 字典以编码关联：scope/backoff_policy_type/lifecycle_status 使用 sys_dict_item.item_code
...
(
  ...
  -- 字典以编码关联：scope/inbound_location/lifecycle_status 使用 sys_dict_item.item_code
