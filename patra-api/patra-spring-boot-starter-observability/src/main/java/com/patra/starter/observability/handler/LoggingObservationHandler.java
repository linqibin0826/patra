...
public class LoggingObservationHandler implements ObservationHandler<Observation.Context> {
  ...
  public void onStart(Observation.Context context) {
    logLevel.log(
        log,
        "Observation started: name={}, contextualName={}",
        context.getName(),
  ...
  public void onStop(Observation.Context context) {
    logLevel.log(
        log,
        "Observation completed: name={}, lowCardinalityKeys={}, highCardinalityKeys={}",
        context.getName(),
  ...
  public void onError(Observation.Context context) {
    ...
    if (error != null) {
      log.error(
          "Observation failed: name={}, error={}", context.getName(), error.getMessage(), error);
    } else {
