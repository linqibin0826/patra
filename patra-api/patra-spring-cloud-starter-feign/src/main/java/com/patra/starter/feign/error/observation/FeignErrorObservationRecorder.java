 ...
 *
 * <p>在解码 Feign 错误响应时记录可观测性指标，用于监控和诊断。
 *
 * <h3>主要用途</h3>
 *
 * <ul>
 *   <li>记录 ProblemDetail 解析性能和结果
 *   <li>跟踪错误解码成功率和容错模式使用情况
 *   <li>监控响应体读取性能和截断情况
 *   <li>记录跟踪标识符提取情况
 * </ul>
 *
 ...
 *
 * <ul>
 *   <li>提供 NO_OP 实现用于禁用观察时的零开销
 *   <li>生产环境使用 {@link MicrometerFeignErrorObservationRecorder} 实现
 *   <li>所有方法均为非阻塞,不影响主流程性能
 * </ul>
 */
