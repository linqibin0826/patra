...
- 当前任务工作记忆文件：`SCRATCHPAD.md`
- 复杂任务开始时，使用 `.codex/prompts/new-task.md` 初始化任务
- 会话结束前更新：进度、关键决策、下一步待办

### 上下文恢复

当需求包含“继续/接着做/上次任务”语义时：

1. 优先读取 `SCRATCHPAD.md`
2. 恢复任务状态与关键约束
3. 明确下一步可执行动作

### 任务归档

- 任务完成后归档到 `.codex/scratchpad-archive/`
- 若有长期架构决策，沉淀到 `../Patra-docs/content/decisions/`
