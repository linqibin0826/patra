...
/// ## 核心组件
/// 
/// - {@link com.patra.catalog.domain.model.aggregate.MeshImportAggregate} - MeSH 导入任务聚合根，管理导入任务的完整生命周期和状态转换
///   - {@link com.patra.catalog.domain.model.aggregate.MeshDescriptorAggregate} - MeSH 主题词聚合根，包含树形编号、入口术语和概念
