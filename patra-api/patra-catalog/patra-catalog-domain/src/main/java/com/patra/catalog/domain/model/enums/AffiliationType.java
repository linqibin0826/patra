 ...
 *
 * <ul>
 *   <li>EDUCATION：教育机构(大学、研究所等)
 *   <li>HEALTHCARE：医疗机构(医院、诊所等)
 *   <li>COMPANY：企业机构(制药公司、生物技术公司等)
 *   <li>GOVERNMENT：政府机构(卫生部、科研机构等)
 *   <li>NONPROFIT：非营利组织(基金会、协会等)
 *   <li>OTHER：其他类型机构
 * </ul>
 *
 * <p><b>使用场景</b>：
 *
 * <ul>
 *   <li>机构分类统计(如统计各类型机构的发文量)
 *   <li>机构筛选(如仅查询教育机构)
 *   <li>机构认证(不同类型机构的认证要求不同)
 * </ul>
 *
 * @author linqibin
 * @since 0.1.0
