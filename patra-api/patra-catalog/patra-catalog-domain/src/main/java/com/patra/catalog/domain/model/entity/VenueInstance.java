 ...
 *
 * <ul>
 *   <li><b>期刊</b>：某卷某期（Volume 29, Issue 3）
 *   <li><b>书籍</b>：某版次（2nd Edition）
 *   <li><b>会议</b>：某届会议（AAAI 2024, San Francisco）
 * </ul>
 *
 * <p><b>业务规则</b>：
 *
 * <ul>
 *   <li>同一Venue的volume+issue组合必须唯一（期刊）
 *   <li>同一Venue的edition必须唯一（书籍）
 *   <li>会议实例必须有会议名称和日期
 *   <li>publication_year必填，用于冗余到Publication表优化查询
 * </ul>
 *
 * <p><b>不变量</b>：
 *
 * <ul>
 *   <li>venueId不能为空（必须属于某个Venue）
 *   <li>publicationYear必填且在合理范围内（1800-2100）
 *   <li>会议结束日期不能早于开始日期
 * </ul>
 *
 * <p>使用示例：
