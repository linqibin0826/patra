 ...
 * MeSH 入口术语词法标记枚举。
 *
 * <p>字段映射：cat_mesh_entry_term.lexical_tag → NON/PEF/LAB/ABB/ACR/NAM
 *
 * <p>类型说明：
 *
 * <ul>
 *   <li><b>NON</b>：无特殊标记(None)
 *   <li><b>PEF</b>：首选术语(Preferred Term)
 *   <li><b>LAB</b>：实验室术语(Laboratory Term)
 *   <li><b>ABB</b>：缩写(Abbreviation)
 *   <li><b>ACR</b>：首字母缩写(Acronym)
 *   <li><b>NAM</b>：命名(Named Entity)
 * </ul>
 *
 * <p>业务规则：
 *
 * <ul>
 *   <li>PEF 标记的术语是该主题词的首选名称
 *   <li>ABB/ACR 标记的术语在检索时需要特殊处理
 *   <li>LAB 标记的术语常用于实验室场景
 * </ul>
 *
 * @author linqibin
 * @since 0.1.0
