 ...
 *
 * <ul>
 *   <li>格式：https://ror.org/0XXXXXX(9位字符)
 *   <li>示例：https://ror.org/03vek6s52
 *   <li>ROR 是全球研究机构的唯一标识符
 *   <li>由 Crossref、DataCite 等组织维护
 * </ul>
 *
 * <p><b>设计原则</b>：
 *
 ...
 *   <li>不可变性：Record 自动提供
 *   <li>格式验证：严格验证 ROR 格式
 *   <li>URL 支持：提供 ROR 官方 URL
 *   <li>ID 提取：提供纯 ID 提取(不含 URL 前缀)
 * </ul>
 *
 * <p><b>使用示例</b>：
 *
