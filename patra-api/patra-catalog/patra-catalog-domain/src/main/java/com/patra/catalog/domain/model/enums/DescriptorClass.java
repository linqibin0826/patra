 ...
 * MeSH 主题词类型枚举。
 *
 * <p>字段映射：cat_mesh_descriptor.descriptor_class → 1/2/3/4
 *
 * <p>类型说明：
 *
 * <ul>
 *   <li><b>TOPICAL</b>：主题词(Topical Descriptor,如 "Antibodies", "Diabetes Mellitus")
 *   <li><b>PUBLICATION_TYPE</b>：出版类型(Publication Type,如 "Review", "Clinical Trial")
 *   <li><b>GEOGRAPHICALS</b>：地理名称(Geographicals,如 "United States", "China")
 *   <li><b>CHECK_TAG</b>：检查标签(Check Tag,如 "Male", "Female", "Human")
 * </ul>
 *
 * <p>业务规则：
 *
 * <ul>
 *   <li>TOPICAL 是最常见的类型,约占 95%
 *   <li>CHECK_TAG 用于标记性别、年龄、人/动物等基本特征
 *   <li>不同类型的主题词在检索时的权重不同
 * </ul>
 *
 * @author linqibin
 * @since 0.1.0
