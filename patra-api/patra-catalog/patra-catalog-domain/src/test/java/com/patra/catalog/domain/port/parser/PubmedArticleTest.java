...
class PubmedArticleTest {
  ...
  class RecordStructureTest {
    ...
    void should_store_all_required_fields() {
      // given
      var article = PubmedArticle.builder()
          .pmid("12345678")
  ...
  class ConvenienceMethodsTest {
    ...
    void should_correctly_check_doi_existence() {
      var withDoi = PubmedArticle.builder()
          .pmid("1").articleTitle("T").nlmUniqueId("N").pubYear(2024)
          .doi("10.1000/test")
          .build();
      var withoutDoi = PubmedArticle.builder()
          .pmid("1").articleTitle("T").nlmUniqueId("N").pubYear(2024)
          .build();
      var withBlankDoi = PubmedArticle.builder()
          .pmid("1").articleTitle("T").nlmUniqueId("N").pubYear(2024)
          .doi("  ")
          .build();
    ...
    void should_correctly_check_pmcid_existence() {
      var withPmc = PubmedArticle.builder()
          .pmid("1").articleTitle("T").nlmUniqueId("N").pubYear(2024)
          .pmcId("PMC123")
          .build();
      var withoutPmc = PubmedArticle.builder()
          .pmid("1").articleTitle("T").nlmUniqueId("N").pubYear(2024)
          .build();
    ...
    void should_return_issn_by_priority() {
      ...
      var withAll = PubmedArticle.builder()
          .pmid("1").articleTitle("T").nlmUniqueId("N").pubYear(2024)
          .issnLinking("1111-1111")
          .issnPrint("2222-2222")
          .issnElectronic("3333-3333")
          .build();
      var withPrintAndElectronic = PubmedArticle.builder()
          .pmid("1").articleTitle("T").nlmUniqueId("N").pubYear(2024)
          .issnPrint("2222-2222")
          .issnElectronic("3333-3333")
          .build();
      var withElectronicOnly = PubmedArticle.builder()
          .pmid("1").articleTitle("T").nlmUniqueId("N").pubYear(2024)
          .issnElectronic("3333-3333")
          .build();
      var withNone = PubmedArticle.builder()
          .pmid("1").articleTitle("T").nlmUniqueId("N").pubYear(2024)
          .build();
