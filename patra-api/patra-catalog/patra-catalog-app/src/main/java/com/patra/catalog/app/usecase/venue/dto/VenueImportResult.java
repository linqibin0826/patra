...
public record VenueImportResult(
  ...
  /// @return 成功结果对象
  public static VenueImportResult success(Long executionId, int fileCount, int totalRecordCount) {
  ...
  /// @return 失败结果对象
  public static VenueImportResult failure(String errorMessage) {
    return new VenueImportResult(
