...
public record MeshDescriptorImportResult(
    Long executionId, String sourceUrl, String filePath, String meshVersion, String message) {
  ...
  public static MeshDescriptorImportResult success(
      Long executionId, String sourceUrl, String filePath, String meshVersion) {
