-- ============================================================
-- Patra Catalog 数据库 - 文献补充数据 DDL
-- ============================================================
-- 版本: V1.5.1
-- 领域: Publication 领域（补充数据）
...
-- ============================================================
-- 文献补充数据 (4张表):
--   1. cat_publication_external_reference (外部引用表) - 依赖 cat_publication
--   2. cat_publication_related_item (相关项目表) - 依赖 cat_publication, 可选依赖自身
--   3. cat_publication_supplemental_object (补充对象表) - 依赖 cat_publication
--   4. cat_publication_history (发布历史表) - 依赖 cat_publication
-- ============================================================


-- ============================================================
-- 表 1: cat_publication_external_reference (外部引用表)
-- ============================================================
...
-- ============================================================
-- 表 2: cat_publication_related_item (相关项目表)
-- ============================================================
...
-- ============================================================
-- 表 3: cat_publication_supplemental_object (补充对象表)
-- ============================================================
...
-- ============================================================
-- 表 4: cat_publication_history (发布历史表)
-- ============================================================
