...
class MeshQualifierParserAdapterIT {
  ...
  class ParseTest {
    ...
    void parse_testXml_shouldReturnThreeQualifiers() {
      // Given: 测试 XML 文件路径
    ...
    void parse_shouldParseDateFieldsCorrectly() {
      // Given
      Path xmlPath = TEST_QUALIFIERS_PATH;
    ...
    void parse_shouldParseHistoryNoteAndOnlineNote() {
      // Given
      Path xmlPath = TEST_QUALIFIERS_PATH;
    ...
    void parse_shouldParseTreeNumbers() {
      // Given
      Path xmlPath = TEST_QUALIFIERS_PATH;
  ...
  class ExceptionTest {
    ...
    private static final Path NON_EXISTENT_PATH =
        Path.of("src/test/resources/xml/non-existent-qualifier.xml");
