...
public final class DomainLayerRules {
   ...
   * <pre>
   * // ✅ 正确：纯 Java 类
   * public class MeshDataAggregate {
   *     private final MeshDataId id;
   ...
   *   <li>com.patra.catalog.domain.* - Domain 层内部
   * </ul>
   *
   * <p><b>Jackson 依赖说明：</b> Domain 层允许使用 Jackson 注解（如 @JsonProperty、@JsonIgnore）用于：
   *
   * <ul>
   *   <li>领域事件序列化
   *   <li>值对象 JSON 映射
   ...
   *   <li>com.patra.catalog.infra.* - 基础设施层
   *   <li>com.patra.catalog.app.* - 应用层
   * </ul>
   */
  public static final ArchRule domain_allowed_dependencies =
      classes()
          ...
          .resideInAnyPackage(
              ...
              "com.patra.catalog.domain.." // Domain 层内部
              )
   ...
   *   <li>com.patra.catalog.app.* - 应用层
   *   <li>com.patra.catalog.infra.* - 基础设施层
   *   <li>com.patra.catalog.adapter.* - 适配器层
   *   <li>com.patra.catalog.boot.* - 启动层
   * </ul>
   *
   * <p><b>原因：</b>
   *
   ...
   *
   * public class MeshDataService {
   *     private MeshDataDO data;  // ❌ 直接依赖 DO
   * }
   * </pre>
   *
   * <p><b>正确示例：</b>
