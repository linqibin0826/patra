...
public final class EncapsulationRules {
  ...
  ///
  /// import com.patra.catalog.infra.persistence.entity.MeshDataDO;  // ❌ 不允许
  ///
  /// public class MeshImportOrchestrator {
  ///     public void process(MeshDataDO data) { ... }  // ❌ 泄露 DO
  /// }
  ///
  /// ```
  ///
  ...
  /// package com.patra.catalog.app.usecase;
  ///
  /// import com.patra.catalog.domain.model.aggregate.MeshDataAggregate;  // ✅ Domain 实体
  ///
  /// public class MeshImportOrchestrator {
  ///     public void process(MeshDataAggregate data) { ... }  // ✅ 使用 Domain 实体
  /// }
  ///
  /// // ✅ 正确：Infra 层内部转换
  ...
  ///
  /// {@literal @}Mapper
  /// public interface MeshDataConverter {
  ///     MeshDataAggregate toDomain(MeshDataDO meshDataDO);  // DO → Domain
  ///     MeshDataDO toDO(MeshDataAggregate data);            // Domain → DO
  /// }
  ///
  /// ```
  ...
  ///
  /// public interface MeshDataRepository {  // ✅ public 接口
  ///     void save(MeshData data);
  ///     Optional&lt;MeshData&gt; findById(MeshDataId id);
  /// }
  ///
  /// ```
  ///
  ...
  /// package com.patra.catalog.domain.port;
  ///
  /// interface MeshDataRepository {  // ❌ 包私有，其他模块无法访问
  ///     void save(MeshData data);
  /// }
  ///
  /// ```
  ...
  ///
  /// // ❌ 错误：Event 在 app 层
  /// package com.patra.catalog.app.event;
  /// public record MeshDataImportedEvent(...) { }
  ///
