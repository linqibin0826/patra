...
/// 版本号会从文件名自动推断（如 `serfilebase.2025.xml` → `2025`）。
///
/// **配置示例**：
///
/// ```yaml
...
///   catalog:
///     serfile:
///       serfile-url: https://ftp.nlm.nih.gov/projects/serfilelease/serfilebase.2025.xml
/// ```
///
/// **数据源说明**：
///
...
public class SerfileDataSourceProperties {
  ...
  ///
  /// 文件名格式必须为 `serfilebase.{year}.xml`，如 `serfilebase.2025.xml`。
  /// 默认使用 2025 年版本。
  @NotBlank(message = "patra.catalog.serfile.serfile-url 不能为空")
  private String serfileUrl = "https://ftp.nlm.nih.gov/projects/serfilelease/serfilebase.2025.xml";
}
