 ...
 * <ul>
 *   <li>作为类型标记，而非业务枚举
 *   <li>包含类型元信息（code, class, description）
 *   <li>支持通过 code 或 class 反查
 * </ul>
 *
 * <h2>架构决策：</h2>
 *
...
public enum DataType {
   ...
   * 期刊指标占位符类
   *
   * <p>TODO: 后续由实际的 JournalMetrics 领域模型替换
   */
   ...
   * 参考文献占位符类
   *
   * <p>TODO: 后续由实际的 Reference 领域模型替换
   */
   ...
   * 药品相互作用占位符类
   *
   * <p>TODO: 后续由实际的 DrugInteraction 领域模型替换
   */
   ...
   * 机构信息占位符类
   *
   * <p>TODO: 后续由实际的 Affiliation 领域模型替换
   */
