 ...
 *
 * <p>行为与原始 starter-core 实现保持一致,以避免引入模块间依赖。
 */
public final class HashUtils {
   ...
   *
   * @param source 输入字符串;{@code null} 被视为空字符串
   ...
   *
   * @param source 输入字节;{@code null} 被视为空数组
   * @return 原始 32 字节 SHA-256 摘要
   */
   ...
   *
   * @param data 要转换的字节
   * @return 十六进制表示;如果输入为 {@code null} 或为空则返回空字符串
   */
   ...
   * @param input 输入字节;{@code null} 被视为空数组
   * @return 摘要结果
   */
