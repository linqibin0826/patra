...
import com.patra.registry.adapter.inbound.rest.feign.converter.DictionaryApiConverter;
...
public class DictionaryClientImpl implements DictionaryClient {
    ...
    private final DictionaryApiConverter dictionaryApiConverter;
    ...
    public DictionaryClientImpl(
            ...
            DictionaryApiConverter dictionaryApiConverter) {
    ...
    public List<DictionaryValidationResp> validateReferences(List<DictionaryReferenceReq> references) {
        ...
        try {
            List<DictionaryReference> domainReferences = dictionaryApiConverter.toReference(references);
