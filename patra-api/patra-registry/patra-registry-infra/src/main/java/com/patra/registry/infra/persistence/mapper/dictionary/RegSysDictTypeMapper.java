...
/**
 * 只读 Mapper,用于表 {@code sys_dict_type}.
 *
 * <p>Provides convenience queries for dictionary type metadata on the query side.
 *
 * <p>SQL implementations reside in {@code resources/mapper/RegSysDictTypeMapper.xml}. To modify
