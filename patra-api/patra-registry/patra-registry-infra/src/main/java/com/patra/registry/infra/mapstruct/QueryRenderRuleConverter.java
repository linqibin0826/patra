...
public interface QueryRenderRuleConverter {
    ...
    @Mapping(target = "op", expression = "java(src.getOp()==null?null:src.getOp().name())")
    @Mapping(target = "matchType", expression = "java(src.getMatchType()==null?null:src.getMatchType().name())")
    @Mapping(target = "valueType", expression = "java(src.getValueType()==null?null:src.getValueType().name())")
    @Mapping(target = "emit", expression = "java(src.getEmit()==null?null:src.getEmit().name())")
