...
class RegistryKeyStandardizerTest {
  ...
  void toUppercaseCode_null_throws() {
    assertThrows(
        DomainValidationException.class, () -> RegistryKeyStandardizer.toUppercaseCode(null));
  }
  ...
  void toTrimmedFieldKey_null_throws() {
    assertThrows(
        DomainValidationException.class, () -> RegistryKeyStandardizer.toTrimmedFieldKey(null));
  }
  ...
  void toNegatedKeyOrAny_null_any_true_T_false_F() {
    ...
    assertEquals(
        RegistryKeyPlaceholders.NEGATED_TRUE, RegistryKeyStandardizer.toNegatedKeyOrAny(true));
    assertEquals(
        RegistryKeyPlaceholders.NEGATED_FALSE, RegistryKeyStandardizer.toNegatedKeyOrAny(false));
  }
