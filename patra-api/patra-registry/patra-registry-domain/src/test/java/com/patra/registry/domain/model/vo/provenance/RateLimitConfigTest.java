 ...
 *   <li>测试 record 的业务约束验证（正整数 ID、非 null 时间戳等）
 ...
 *   <li>✅ 字符串 trim 处理测试（operationType）
 *   <li>✅ 可选字段处理（effectiveTo, maxConcurrentRequests, perCredentialQpsLimit 允许为 null）
 *   <li>✅ record 的 equals/hashCode/toString 测试
 *   <li>✅ 不变性保证
 *   <li>✅ 业务场景测试（不同操作类型、速率限制配置等）
 *   <li>✅ 边界条件处理
 * </ul>
 *
 * @author Patra Team
