 ...
 *
 * <p>This port abstracts persistence concerns for expression fields, capabilities, render rules,
 * and API parameter mappings.
 *
 * @author linqibin
 * @since 0.1.0
 */
public interface ExprRepository {
   ...
   * @param operationType the operation type (HARVEST/UPDATE/BACKFILL); nullable for cross-operation
   *     queries
   * @param endpointName the endpoint name for scoped configuration; nullable for endpoint-agnostic
   *     queries
