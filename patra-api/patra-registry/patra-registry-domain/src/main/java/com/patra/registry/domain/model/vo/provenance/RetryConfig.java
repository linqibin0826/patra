 ...
 *
 * <p>Configure retry attempts, backoff policy (fixed/exponential + jitter), circuit breaker
 * threshold/cooldown, per error category (HTTP/network/client). Works with HTTP Retry-After policy;
 * controls 429/5xx/network/client errors.
 *
 * @author linqibin
 * @since 0.1.0
 */
