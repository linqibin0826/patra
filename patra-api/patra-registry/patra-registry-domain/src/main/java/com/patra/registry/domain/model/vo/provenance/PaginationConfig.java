 ...
 *
 * <p>Configure page/cursor/token/scroll pagination params and response extraction rules
 * (JSONPath/XPath). At most one currently effective row per endpoint definition; endpoint-level
