 ...
 * @since 0.0.1
 */
public enum LiteratureProvenanceCode implements CodeEnum<String> {
    ...
    LiteratureProvenanceCode(String code, String display) {
        this.code = code;
     ...
     */
    public static LiteratureProvenanceCode parse(String s) {
        if (s == null)
