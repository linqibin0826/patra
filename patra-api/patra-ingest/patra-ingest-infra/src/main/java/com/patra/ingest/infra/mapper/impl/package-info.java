...
// 参数映射器（retstart/retmax + WebEnv/query_key）
///   - {@link com.patra.ingest.infra.mapper.impl.EpmcParameterMapper} - EPMC 参数映射器（pageSize/page +
// cursorMark）
///   - {@link com.patra.ingest.infra.mapper.impl.DoajParameterMapper} - DOAJ 参数映射器（pageSize/page +
// Scroll API）
///
/// ## 实现规范
///
...
///   "scroll_id": "..."                  //
// metadata.stateToken(StateTokenKeys.DOAJ_CURSOR_MARK)（如有）
/// ```
///
/// ## 扩展指南
///
...
///                 params.put(CrossrefParamKeys.CURSOR,
// token.get(StateTokenKeys.CROSSREF_CURSOR)););
///
///         return params;
/// ```
///
