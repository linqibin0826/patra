package dev.linqibin.patra.ingest.infra.integration.provenance;
...
import dev.linqibin.patra.starter.provenance.common.provider.ProvenanceDataProvider;
import dev.linqibin.patra.starter.provenance.common.provider.ProviderNotFoundException;
import dev.linqibin.patra.starter.provenance.common.provider.ProviderRegistry;
import dev.linqibin.patra.starter.provenance.common.provider.ProviderRequest;
import dev.linqibin.patra.starter.provenance.common.provider.ProviderResult;
...
public class ProvenanceDataAdapter implements ProvenanceDataPort {
  ...
  private PaginationConfig toPaginationConfig(
      dev.linqibin.patra.ingest.domain.model.snapshot.ProvenanceConfigSnapshot.PaginationConfig
          paginationInfo) {
  ...
  private WindowOffsetConfig toWindowOffsetConfig(
      dev.linqibin.patra.ingest.domain.model.snapshot.ProvenanceConfigSnapshot.WindowOffsetConfig
          windowOffsetInfo) {
  ...
  private RateLimitConfig toRateLimitConfig(
      dev.linqibin.patra.ingest.domain.model.snapshot.ProvenanceConfigSnapshot.RateLimitConfig
          rateLimitInfo) {
