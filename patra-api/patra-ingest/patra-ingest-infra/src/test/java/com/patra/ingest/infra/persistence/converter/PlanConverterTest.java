...
///   - 测试所有 PlanStatus 枚举值的转换
///   - 测试所有 WindowSpec 策略的转换
///   - 测试 JSON 字段的转换（exprProtoSnapshot, provenanceConfigSnapshot, sliceParams）
///   - 测试 denormalized 时间戳字段的处理（windowFromTs/windowToTs）
///   - 测试双向转换一致性
///   - 测试 null 安全性
/// 
/// @author linqibin
