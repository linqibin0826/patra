...
public final class NamingConventionRules {
     ...
     * // ❌ 错误：命名不符合约定
     * package com.patra.ingest.domain.port;
     * public interface PlanService { ... }  // 应该用 Port 或 Repository 结尾
     * </pre>
     */
    public static final ArchRule ports_should_reside_in_domain_port_package =
        classes()
            ...
            .and().areInterfaces()
            .and().haveSimpleNameNotContaining("package-info")  // 排除文档类
     ...
     * package com.patra.ingest.domain.repository;
     * public class PlanRepositoryImpl implements PlanRepository { ... }
     *
     * // ❌ 错误：Port 实现在 app 层
     * package com.patra.ingest.app.repository;
     * public class PlanRepositoryImpl implements PlanRepository { ... }
     * </pre>
     */
    public static final ArchRule repository_impls_should_reside_in_infra =
        classes()
            .that().resideInAPackage("..ingest..")  // 限制在 ingest 模块
            .and().areNotInterfaces()
            .and().implement(com.tngtech.archunit.core.domain.JavaClass.Predicates.resideInAPackage("..domain.port.."))
    ...
    public static final ArchRule do_classes_should_reside_in_persistence_entity =
        classes()
            ...
            .should().resideInAPackage("..infra.persistence.entity..")
     ...
     * package com.patra.ingest.infra.model;
     * public class PlanAggregate { ... }
     * </pre>
     */
     ...
     * <p><b>命名模式：</b>
     * <ul>
     *   <li>*Orchestrator：主编排器（如 PlanIngestionOrchestrator）
     *   <li>*Coordinator：辅助协调器（如 PlanPersistenceCoordinator）
     * </ul>
     *
     * <p><b>正确示例：</b>
     * <pre>
    ...
    public static final ArchRule orchestrators_should_reside_in_app_usecase =
        classes()
            ...
            .or().haveSimpleNameEndingWith("Coordinator")
            .should().resideInAPackage("..app.usecase..")
