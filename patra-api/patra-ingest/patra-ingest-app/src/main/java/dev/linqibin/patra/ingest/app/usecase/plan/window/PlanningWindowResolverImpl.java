...
import static dev.linqibin.patra.ingest.app.usecase.plan.window.PlanningWindowSupport.alignFloor;
import static dev.linqibin.patra.ingest.app.usecase.plan.window.PlanningWindowSupport.computeLaggedNow;
import static dev.linqibin.patra.ingest.app.usecase.plan.window.PlanningWindowSupport.isCalendarMode;
import static dev.linqibin.patra.ingest.app.usecase.plan.window.PlanningWindowSupport.maxInstant;
import static dev.linqibin.patra.ingest.app.usecase.plan.window.PlanningWindowSupport.minInstant;
import static dev.linqibin.patra.ingest.app.usecase.plan.window.PlanningWindowSupport.resolveDuration;
import static dev.linqibin.patra.ingest.app.usecase.plan.window.PlanningWindowSupport.resolveWindowSize;
import static dev.linqibin.patra.ingest.app.usecase.plan.window.PlanningWindowSupport.resolveZone;
...
/// fromCandidate = harvestWM? max(user.from?, harvestWM - lookback) : (user.from? | toCandidate -
// windowSize)
/// CALENDAR 对齐 -> 空窗口检查
///
/// ```
...
/// fromCandidate = backfillWM? max(backfillWM, user.from?) : (user.from? | upperAnchor -
// windowSize)
