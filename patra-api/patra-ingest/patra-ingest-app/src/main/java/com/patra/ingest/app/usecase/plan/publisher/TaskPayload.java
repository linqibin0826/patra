 ...
 *
 * <p>Contains only essential data required by downstream consumers. All other business data
 * (provenance, operation, params, etc.) should be queried from the database using the taskId.
 *
