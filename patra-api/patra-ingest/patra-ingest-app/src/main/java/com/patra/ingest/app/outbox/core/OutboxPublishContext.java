 ...
 *
 * <p>Replaces variable-length arguments with type-safe context map.
 *
 * <p>This class is immutable and thread-safe. All context data is defensively copied.
 *
 * <h3>Usage Example</h3>
 *
 * <pre>{@code
  ...
  public <T> T get(String key, Class<T> type) {
    ...
    if (!type.isInstance(value)) {
      throw new ClassCastException(
          String.format(
              "Context value for key '%s' is not of type %s, actual: %s",
