 ...
 *
 * <p>Aggregates WindowOffset configuration helpers and time utilities for reuse by
 * application-layer window resolution strategies. All methods are pure functions to make unit
 * testing and reuse straightforward.
 *
 * <p>This class is stateless and not instantiable.
 *
 * @author linqibin
 * @since 0.1.0
 */
