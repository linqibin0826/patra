 ...
 * <p>Implementations may forward events to logs, monitoring systems, message queues, or local event buses.</p>
 * <p>Contract: tolerate individual event failures and log them to avoid disrupting the main relay flow.</p>
 */
