...
class RelayRetryPolicyTest {
  ...
  void ctor_shouldValidateArguments() {
    assertThrows(
        ...
        () -> new RelayRetryPolicy(null, 2.0, Duration.ofSeconds(10)));
    assertThrows(
        IllegalArgumentException.class,
        () -> new RelayRetryPolicy(Duration.ZERO, 2.0, Duration.ofSeconds(10)));
    assertThrows(
        IllegalArgumentException.class,
        () -> new RelayRetryPolicy(Duration.ofSeconds(-1), 2.0, Duration.ofSeconds(10)));

    assertThrows(
        IllegalArgumentException.class,
        () -> new RelayRetryPolicy(Duration.ofMillis(1), 2.0, null));
    assertThrows(
        IllegalArgumentException.class,
        () -> new RelayRetryPolicy(Duration.ofMillis(1), 2.0, Duration.ZERO));
    assertThrows(
        IllegalArgumentException.class,
        () -> new RelayRetryPolicy(Duration.ofMillis(1), 2.0, Duration.ofSeconds(-1)));

    assertThrows(
        IllegalArgumentException.class,
        () -> new RelayRetryPolicy(Duration.ofMillis(1), 0.9, Duration.ofSeconds(1)));
  }
  ...
  void computeDelay_shouldReturnBaseWhenFirstAttempt() {
    RelayRetryPolicy policy =
        new RelayRetryPolicy(Duration.ofSeconds(2), 2.0, Duration.ofSeconds(10));
  ...
  void computeDelay_shouldExponentialBackoffAndClamp() {
    RelayRetryPolicy policy =
        new RelayRetryPolicy(Duration.ofSeconds(1), 2.0, Duration.ofSeconds(5));
  ...
  void computeDelay_shouldReturnMaxWhenOverflow() {
    RelayRetryPolicy policy =
        new RelayRetryPolicy(Duration.ofMillis(1), 2.0, Duration.ofSeconds(10));
