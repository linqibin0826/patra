 ...
 * <ul>
 *   <li>验证构造器的非空约束</li>
 *   <li>验证 record 语义（equals/hashCode/toString）</li>
 *   <li>验证业务方法（isHarvest/isBackfill/isUpdate）</li>
 *   <li>测试边界条件和各种参数组合</li>
 * </ul>
 */
...
class PlanTriggerNormTest {
    ...
    class ConstructorValidationTests {
        ...
        void shouldCreateInstanceWithAllFields() {
            ...
            // When
            PlanTriggerNorm norm = new PlanTriggerNorm(
                    scheduleInstanceId,
                    provenanceCode,
                    operationCode,
                    step,
        ...
        void shouldThrowNullPointerExceptionWhenScheduleInstanceIdIsNull() {
            ...
            // When & Then
            assertThatThrownBy(() -> new PlanTriggerNorm(
                    scheduleInstanceId,
                    ProvenanceCode.PUBMED,
                    OperationCode.HARVEST,
                    "step",
    ...
    class RecordSemanticsTests {
        ...
        void shouldNotBeEqualWhenFieldsAreDifferent() {
            // Given
            PlanTriggerNorm norm1 = createValidNorm();
            PlanTriggerNorm norm2 = new PlanTriggerNorm(
