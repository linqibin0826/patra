 ...
 *
 * <ul>
 *   <li>provenanceCode - 数据源标识(如 PUBMED、EPMC)
 *   <li>endpointName - 端点名称(如 SEARCH、DETAIL),可选,可为 null
 *   <li>rawExpression - 待编译的 JSON 表达式快照
 * </ul>
 *
 * <p><b>业务场景:</b>
 *
 * <ul>
 *   <li>将注册中心的表达式配置快照编译为可执行的表达式实例
 *   <li>支持多数据源、多端点的表达式编译
 *   <li>endpointName 为 null 时表示全局配置
 * </ul>
 *
