 ...
 * <p>Uses a UTC half-open interval {@code [from, to)}. {@code null} values indicate unbounded/full ranges.</p>
 * <p>Typical usage:
 * <ul>
 *   <li>{@link #full()} returns an unbounded window for full refreshes.</li>
 *   <li>{@code new PlannerWindow(from, to)} supplies a concrete time slice.</li>
 *   <li>{@link #isFull()} checks whether the window is unbounded.</li>
 *   <li>{@link #isEmpty()} detects invalid (non-forward) ranges.</li>
 * </ul></p>
 */
