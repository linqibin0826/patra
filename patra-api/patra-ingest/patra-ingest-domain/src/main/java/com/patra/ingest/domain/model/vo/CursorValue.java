 ...
 * <p>Retains the raw string alongside parsed forms for comparison and sorting.</p>
 * <ul>
 *   <li>{@code type}: cursor type {@link CursorType}</li>
 *   <li>{@code raw}: normalized raw value</li>
 *   <li>{@code instant}: parsed instant when the cursor represents time</li>
 *   <li>{@code numeric}: parsed numeric value when applicable</li>
 * </ul>
 */
