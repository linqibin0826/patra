 ...
 *
 * <p>Occurs after validation succeeds but the slicing/task generation stages cannot produce executable
 * batches. Unlike {@link PlanValidationException}, inputs are valid; the failure stems from assembly
 * algorithms or combination rules.</p>
 * <p>Handling strategy:
 * <ul>
 *   <li>{@link Reason#EMPTY_RESULT}: treat as an empty window, log at INFO, and stop creation.</li>
 *   <li>{@link Reason#SLICE_GENERATION_FAILED} / {@link Reason#TASK_GENERATION_FAILED}: log at ERROR and inspect
 *   the strategy implementation or baseline data.</li>
 * </ul>
 * </p>
 */
public class PlanAssemblyException extends IngestException implements HasErrorTraits {
     ...
     * <p>Helps callers select log levels and alerting strategies.</p>
     */
    public enum Reason {
