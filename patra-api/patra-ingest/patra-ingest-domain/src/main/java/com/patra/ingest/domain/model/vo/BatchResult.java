 ...
 *
 * <p>Captures success flag, row counts, cursor token, error message, and storage key.
 *
 * <p>Invariants:
 *
 * <ul>
 *   <li>{@code batchNo} >= 1
 *   <li>{@code fetchedCount} >= 0
 *   <li>When {@code success} is {@code false}, {@code errorMessage} must be present
 * </ul>
 *
