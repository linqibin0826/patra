 ...
 *
 * <p>Exposes endpoints for executing external HTTP calls with resilience patterns
 * (rate limiting, circuit breaking, retries) to internal microservices via Feign
...
public interface EgressEndpoint {
     ...
     * which applies resilience patterns and returns a standardized response
     * envelope with metadata.</p>
     *
     * @param request the external call request containing URL, method, headers,
     *                body, and optional resilience config
