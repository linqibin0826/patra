 ...
 *
 * <p>Provides standardized error codes for the egress gateway service.
 * Uses HttpStdErrors for HTTP-aligned errors (0xxx segment) and custom
 * ErrorCodeLike implementations for business errors (1xxx+ segment).</p>
 *
 * @author linqibin
 * @since 0.1.0
 */
public final class EgressErrors {
    ...
    public static final ErrorCodeLike CONFIG_LOAD_FAILED = businessError("1001", 500,
        "Failed to load system configuration");

    /** EGR-1002: Config validation failed */
    public static final ErrorCodeLike CONFIG_VALIDATION_FAILED = businessError("1002", 422,
        "Configuration validation failed");

    /** EGR-1003: External service call failed */
    public static final ErrorCodeLike EXTERNAL_CALL_FAILED = businessError("1003", 502,
        "External service call failed");

    /** EGR-1004: Response envelope build failed */
    public static final ErrorCodeLike RESPONSE_ENVELOPE_FAILED = businessError("1004", 500,
