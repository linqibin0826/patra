 ...
 * @since 0.1.0
 */
@DisplayName("HttpResponse value object tests")
class HttpResponseTest {

    @Test
    @DisplayName("isSuccess() should return true for HTTP 200")
    ...
    @Test
    @DisplayName("isSuccess() should return true for any 2xx status")
    ...
    @Test
    @DisplayName("isSuccess() should return false for 4xx statuses")
    ...
    @Test
    @DisplayName("isSuccess() should return false for 5xx statuses")
    ...
    @Test
    @DisplayName("isSuccess() should return false for 3xx statuses")
    ...
    @Test
    @DisplayName("Constructor should create an immutable copy of the headers")
    void constructor_shouldCreateImmutableCopyOfHeaders() {
        ...
        // Then - headers inside the response should remain unaffected
