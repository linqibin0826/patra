package com.patra.egress.adapter.inbound.rest;
...
/**
 * Integration tests for EgressEndpointImpl
 *
 * @author linqibin
 * @since 0.1.0
 */
@WebMvcTest(controllers = EgressEndpointImpl.class)
@ContextConfiguration(classes = {EgressEndpointImpl.class})
class EgressEndpointImplTest {
