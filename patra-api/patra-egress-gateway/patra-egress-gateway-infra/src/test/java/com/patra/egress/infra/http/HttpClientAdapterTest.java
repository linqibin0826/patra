...
class HttpClientAdapterTest {
  ...
  void shouldSuccessfullyExecuteGetRequest() {
    ...
    HttpRequest request =
        new HttpRequest(
            baseUrl + "/api/test", HttpMethod.GET, Map.of("User-Agent", "Test-Client"), null);
  ...
  void shouldHandleClientErrorResponse() {
    ...
    HttpRequest request = new HttpRequest(baseUrl + "/api/notfound", HttpMethod.GET, null, null);
  ...
  void shouldHandleServerErrorResponse() {
    ...
    HttpRequest request = new HttpRequest(baseUrl + "/api/error", HttpMethod.GET, null, null);
  ...
  void shouldReturnResponseHeaders() {
    ...
    HttpRequest request = new HttpRequest(baseUrl + "/api/headers", HttpMethod.GET, null, null);
  ...
  void shouldSupportDeleteRequest() {
    ...
    wireMockServer.stubFor(
        delete(urlEqualTo("/api/delete/123")).willReturn(aResponse().withStatus(204)));

    HttpRequest request =
        new HttpRequest(baseUrl + "/api/delete/123", HttpMethod.DELETE, null, null);
  ...
  void shouldSupportPatchRequest() {
    ...
    wireMockServer.stubFor(
        patch(urlEqualTo("/api/patch/123"))
            .withRequestBody(equalToJson(patchBody))
            .willReturn(
                aResponse().withStatus(200).withBody("{\"id\":123,\"status\":\"inactive\"}")));
  ...
  void shouldSupportHeadRequest() {
    ...
    HttpRequest request = new HttpRequest(baseUrl + "/api/resource", HttpMethod.HEAD, null, null);
  ...
  void shouldSupportOptionsRequest() {
    ...
    wireMockServer.stubFor(
        options(urlEqualTo("/api/resource"))
            .willReturn(
                aResponse()
                    .withStatus(200)
    ...
    HttpRequest request =
        new HttpRequest(baseUrl + "/api/resource", HttpMethod.OPTIONS, null, null);
  ...
  void shouldHandleRateLimitResponse() {
    ...
    wireMockServer.stubFor(
        get(urlEqualTo("/api/ratelimited"))
            .willReturn(
                aResponse()
                    .withStatus(429)
    ...
    HttpRequest request = new HttpRequest(baseUrl + "/api/ratelimited", HttpMethod.GET, null, null);
  ...
  void shouldPassCustomRequestHeaders() {
    ...
    wireMockServer.verify(
        getRequestedFor(urlEqualTo("/api/secured"))
            .withHeader("Authorization", equalTo("Bearer test-token"))
            .withHeader("X-Custom-Header", equalTo("custom-value")));
  }
  ...
  void shouldHandleEmptyResponseBody() {
    ...
    wireMockServer.stubFor(get(urlEqualTo("/api/empty")).willReturn(aResponse().withStatus(200)));

    HttpRequest request = new HttpRequest(baseUrl + "/api/empty", HttpMethod.GET, null, null);
  ...
  void shouldHandleLargeResponseBody() {
    ...
    HttpRequest request = new HttpRequest(baseUrl + "/api/large", HttpMethod.GET, null, null);
  ...
  void shouldHandleSpecialCharactersInJsonResponse() {
    ...
    HttpRequest request = new HttpRequest(baseUrl + "/api/special", HttpMethod.GET, null, null);
  ...
  void shouldHandleUrlQueryParameters() {
    ...
    HttpRequest request =
        new HttpRequest(
            baseUrl + "/api/search?q=cancer&limit=10&offset=0", HttpMethod.GET, null, null);
  ...
  void shouldHandleMultiValueResponseHeaders() {
    ...
    wireMockServer.stubFor(
        get(urlEqualTo("/api/multiheader"))
            .willReturn(
                aResponse()
                    .withStatus(200)
    ...
    HttpRequest request = new HttpRequest(baseUrl + "/api/multiheader", HttpMethod.GET, null, null);
  ...
  void shouldHandleRequestWithoutHeaders() {
    ...
    wireMockServer.stubFor(
        get(urlEqualTo("/api/simple"))
            .willReturn(aResponse().withStatus(200).withBody("Simple response")));
