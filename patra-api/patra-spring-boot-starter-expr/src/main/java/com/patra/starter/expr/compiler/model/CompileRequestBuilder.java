...
public class CompileRequestBuilder {
  ...
  ///
  /// @param operationType 大写的操作类型;`null` 则回退到 Provenance 级别的默认值
  /// @return 本构建器
  ...
  /// 应用自定义编译选项。
  ///
  /// @param options 编译选项;`null` 时使用默认值
  /// @return 本构建器
  ...
  /// 设置最大渲染查询长度。
  ///
  /// @param maxQueryLength 最大长度;`0` 表示无限制
  /// @return 本构建器
  ...
  /// 切换渲染跟踪。
  ///
  /// @param traceEnabled `true` 表示捕获详细的跟踪信息
  /// @return 本构建器
