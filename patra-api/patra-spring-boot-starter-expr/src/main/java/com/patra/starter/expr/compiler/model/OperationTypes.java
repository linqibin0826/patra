...
public final class OperationTypes {
   ...
   *
   * <p>This is the most common operation type and often uses aggressive parameters to capture fresh
   * content.
   */
   ...
   *
   * <p>Often used for initialization or periodic refreshes that require special handling for large
   * data volumes.
   */
   ...
   *
   * <p>Usually optimized for latency and may rely on different timeout or retry policies.
   */
