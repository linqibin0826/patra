...
/** P4.2.7 — STRICT mode: missing fn_code escalates to E-FN-NOTFOUND. */
@DisplayName("Compiler STRICT Function Tests")
class CompilerStrictFunctionTest {

  @Test
  @DisplayName("Missing function warning from renderer becomes error in STRICT mode")
  void missingFunctionBecomesErrorInStrict() {
    ...
    // Renderer returns a warning indicating missing function code
    ...
    assertThat(result.report().errors())
        .anySatisfy(e -> assertThat(e.code()).isEqualTo("E-FN-NOTFOUND"));
