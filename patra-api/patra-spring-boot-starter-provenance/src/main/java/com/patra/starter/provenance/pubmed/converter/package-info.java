 ...
 * PubMed 转换器包。
 *
 * <p>负责将 PubMed 响应对象转换为 StandardLiterature 标准模型。
 *
 * <h2>职责</h2>
 *
 * <ul>
 ...
 *   <li>转换为 {@code StandardLiterature} 标准模型
 *   <li>处理不完整或缺失的字段
 * </ul>
 *
 * <h2>核心组件</h2>
 ...
 * StandardLiterature literature = converter.convert(article);
 * }</pre>
 *
 * @since 0.1.0
 * @author linqibin
