...
/// 批次执行的完整参数
///
/// 包含提供者构建上游 API 请求所需的全部信息:
///
/// - 任务编译产生的基础参数(如 datetype, sort)
///   - 分页参数(如 retstart, retmax)
///   - 运行时状态(如 PubMed 的 WebEnv, query_key)
///
/// **使用场景:**
///
/// - 提供者从此对象获取所有必需的请求参数
///   - 与 {@link ProviderRequest} 一起传递,确保参数完整性
///   - 支持有状态的API调用(如PubMed的会话状态管理)
///
