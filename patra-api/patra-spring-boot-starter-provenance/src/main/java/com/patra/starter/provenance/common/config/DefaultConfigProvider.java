 ...
 *
 * <p>Builds ProvenanceConfig objects from {@link ProvenanceProperties}. The
 * provider guarantees non-null baseUrl and HTTP configuration so that caller
 * logic can rely on them without additional null guards.</p>
 *
 * @author linqibin
 * @since 0.1.0
 */
public class DefaultConfigProvider {
    ...
    private HttpConfig toHttpConfig(HttpConfigProperties props) {
        ...
        Map<String, String> headers = properties.getDefaultHeaders() == null
            ? Map.of()
    ...
    private WindowOffsetConfig toWindowOffsetConfig(WindowOffsetProperties props) {
        ...
        if (props.getWindowModeCode() == null && props.getWindowSizeValue() == null
            && props.getWindowSizeUnitCode() == null && props.getLookbackValue() == null
            && props.getLookbackUnitCode() == null && props.getOverlapValue() == null
            && props.getOverlapUnitCode() == null && props.getOffsetTypeCode() == null
