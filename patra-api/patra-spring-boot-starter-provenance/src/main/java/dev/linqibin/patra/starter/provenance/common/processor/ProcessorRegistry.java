...
public class ProcessorRegistry {
  ...
  /// DEBUG   - PUBLICATION: dev.linqibin.patra.starter.provenance.processor.PublicationProcessor
  /// DEBUG   - JOURNAL: dev.linqibin.patra.starter.provenance.processor.JournalProcessor
  ///
  /// ```
