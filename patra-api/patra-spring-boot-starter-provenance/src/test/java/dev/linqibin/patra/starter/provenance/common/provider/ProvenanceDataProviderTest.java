...
class ProvenanceDataProviderTest {
  ...
  private static class MockPublicationProcessor implements DataProcessor<CanonicalPublication> {
    ...
    @Override
    public dev.linqibin.patra.starter.provenance.common.processor.ValidationResult validate(
        CanonicalPublication data) {
      return dev.linqibin.patra.starter.provenance.common.processor.ValidationResult.success();
    }
