...
> **技术栈**: Java 25, Spring Boot 4.0.6, Spring Data JPA, PostgreSQL 17

---

## 📖 什么是 Patra?

Patra 是一个**医学出版物数据平台**,旨在:
...
- 服务注册中心 (Nacos) 在端口 8848 运行，提供服务发现和健康检查功能。
...
- **命名**: `*Aggregate`, `*Handler`, `*RepositoryAdapter`
