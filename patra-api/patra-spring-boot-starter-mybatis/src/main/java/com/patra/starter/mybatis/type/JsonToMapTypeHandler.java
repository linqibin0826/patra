...
/**
 * A TypeHandler for converting between a {@code Map<String, Object>} and a JSON string stored in a
 * database column (e.g., JSON, TEXT, or VARCHAR).
 *
 * <p><b>Functionality:</b>
 *
 * <ul>
 *   <li><b>Writing:</b> Serializes a {@code Map<String, Object>} into a JSON string using {@code
 *       setString}.
 *   <li><b>Reading:</b> Deserializes a JSON string from the database into a {@code Map<String,
 *       Object>} using {@code getString}.
 *   <li><b>Validation:</b> Performs a lightweight check to ensure the JSON string represents an
 *       object (i.e., starts with '{').
 * </ul>
 */
