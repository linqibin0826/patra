 ...
 *
 * <p>本包提供 patra-object-storage 服务的 OpenFeign 客户端接口,供其他微服务进行类型安全的 RPC 调用。 所有客户端接口都是六边形架构 API
 * 层的一部分,继承端点契约并添加 Feign 注解,实现服务间透明远程调用。
 *
 * <h2>核心客户端</h2>
 *
 * <ul>
 *   <li>{@link com.patra.objectstorage.api.client.StorageClient} - Storage 服务 Feign 客户端,扩展 {@link
 ...
 *   <li><strong>服务发现</strong>: 通过 {@code @FeignClient(name = "patra-object-storage")} 集成 Nacos 服务发现
 ...
 *
 * <ul>
 *   <li><strong>服务名</strong>: {@code name = "patra-object-storage"} - 对应 Nacos 注册的服务名
 ...
 *
 * <ul>
 *   <li>端点契约: {@link com.patra.objectstorage.api.endpoint.StorageEndpoint}
