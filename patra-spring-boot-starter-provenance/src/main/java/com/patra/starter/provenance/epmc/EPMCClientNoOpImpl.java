...
/**
 * No-op implementation of EPMCClient when EgressGatewayClient is not available. Returns empty
...
public class EPMCClientNoOpImpl implements EPMCClient {
  ...
  public SearchResponse search(SearchRequest request, ProvenanceConfig config) {
    log.warn(
        "[PROVENANCE][CORE] EgressGatewayClient not available, returning empty search response");
