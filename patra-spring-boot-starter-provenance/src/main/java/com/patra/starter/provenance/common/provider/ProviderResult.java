...
public record ProviderResult(
   ...
   * @return 可重试的失败结果
   */
  public static ProviderResult retriableFailure(String errorMessage) {
    return new ProviderResult(false, List.of(), null, errorMessage, 0, ErrorType.RETRIABLE);
  }
   ...
   * @return 终止性失败结果
   */
  public static ProviderResult nonRetriableFailure(String errorMessage) {
    return new ProviderResult(false, List.of(), null, errorMessage, 0, ErrorType.NON_RETRIABLE);
  }
   ...
   * @return 部分成功结果
   */
  public static ProviderResult partialSuccess(
      List<CanonicalLiterature> literatures,
      String nextCursorToken,
