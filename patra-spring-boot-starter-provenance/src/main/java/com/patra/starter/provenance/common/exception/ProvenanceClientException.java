 ...
 * Provenance 客户端异常基类
 *
 * <p>封装通过 HTTP 直接调用 provenance 数据源时发生的下游错误。捕获额外的元数据 (HTTP 状态码、trace/correlation ID、响应体)以辅助故障排查。
 *
 * <p><b>包含的诊断信息:</b>
 *
 * <ul>
 *   <li>provenanceCode - 数据源标识符
 *   <li>apiName - 失败的API方法名
 *   <li>statusCode - HTTP 状态码(可选)
 *   <li>traceId - 跟踪标识符(可选)
 *   <li>responseBody - 原始响应体(可选)
 * </ul>
 *
 * @author linqibin
 * @since 0.1.0
