 ...
 *
 * <p>Expose source specific configuration that can be overridden in Nacos or application.yml. Each
 * nested properties object keeps optional fields nullable so that callers may decide which knobs to
 * configure.
 *
 * @author linqibin
 * @since 0.1.0
...
public class ProvenanceProperties {
  ...
  private SourceProperties pubmed =
      SourceProperties.withDefaults("https://eutils.ncbi.nlm.nih.gov/entrez/eutils");

  /** Europe PMC configuration namespace. */
  private SourceProperties epmc =
      SourceProperties.withDefaults("https://www.ebi.ac.uk/europepmc/webservices/rest");
