 ...
 *
 * <p>Tests cover Format B serialization/deserialization, boundary conditions,
 * and exception scenarios for all strategy types.</p>
 *
 * @author linqibin
 * @since 0.1.0
 */
...
class WindowSpecTest {
    ...
    void timeToMap_normalCase() {
        ...
        assertThat(boundaryMap)
            .containsEntry("from", "CLOSED")
            .containsEntry("to", "OPEN");
    }
    ...
    void idRangeToMap_normalCase() {
        ...
        // then
        assertThat(map)
            .containsEntry("strategy", "ID_RANGE")
            .containsKey("window");

        @SuppressWarnings("unchecked")
        Map<String, Object> windowMap = (Map<String, Object>) map.get("window");
        assertThat(windowMap)
            .containsEntry("from", 1000000L)
            .containsEntry("to", 2000000L);
    }
    ...
    void cursorToMap_normalCase() {
        // given
        WindowSpec.CursorLandmark spec = new WindowSpec.CursorLandmark("cursor_token_1", "cursor_token_2");
        ...
        // then
        assertThat(map)
            .containsEntry("strategy", "CURSOR_LANDMARK")
            .containsKey("window");
    ...
    void cursorToMap_specialCharacters() {
        ...
        WindowSpec.CursorLandmark spec2 = new WindowSpec.CursorLandmark("a".repeat(1000), "b".repeat(1000));
    ...
    void cursorRoundtrip() {
        // given
        WindowSpec.CursorLandmark original = new WindowSpec.CursorLandmark("page_1_token", "page_100_token");
    ...
    void fromMap_time_missingFrom() {
        ...
        Map<String, Object> map = Map.of(
            "strategy", "TIME",
            "window", Map.of("to", "2024-12-31T23:59:59Z")
        );
