...
class LiteratureDataReadyEventTest {
    ...
    class ToStringTests {
        ...
        void shouldHandleEmptyStorageKeys() {
            ...
            assertThat(result)
                .contains("storageKeys=[]")
                .contains("totalLiteratureCount=0");
        }
    }
    ...
    class BoundaryConditionTests {
        ...
        void shouldSupportLargeNumberOfStorageKeys() {
            // Given
            var largeKeyList = java.util.stream.IntStream.range(0, 1000)
        ...
        void shouldSupportSpecialCharactersInStorageKeys() {
            ...
            assertThat(event.storageKeys())
                .hasSize(4)
                .containsExactlyElementsOf(specialKeys);
        }
    }
