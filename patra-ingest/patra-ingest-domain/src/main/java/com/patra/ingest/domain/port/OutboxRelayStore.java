...
/**
 * Persistence port used by the outbox relay to fetch publishable messages and drive state transitions.
 * <p>Abstracts storage interactions so the relay can acquire leases, record publish outcomes, and schedule
 * retries.</p>
 *
 * @author linqibin
 * @since 0.1.0
...
public interface OutboxRelayStore {
     ...
     * <p>Supports optional channel filtering:</p>
     * <ul>
     *   <li>If {@code channel} is non-null, restrict to that channel.</li>
     *   <li>If {@code channel} is null, fetch across all channels.</li>
     * </ul>
     *
