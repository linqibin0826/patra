 ...
 *
 * <p>Responsibility: provide a lightweight count estimation for a compiled
 * PubMed search term and parameters, without fetching the full dataset.
 * Implementations must avoid performing any business logic and simply
 * delegate to the upstream client/gateway.
 * </p>
 */
