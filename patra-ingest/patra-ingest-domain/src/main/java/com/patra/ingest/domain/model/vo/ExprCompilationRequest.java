 ...
 *
 * <p>Contains the minimal information needed for expression compilation:
 *
 * <ul>
 *   <li>provenanceCode - Data source identifier (e.g., PUBMED, EPMC)
 *   <li>endpointName - Endpoint name (e.g., SEARCH, DETAIL). Optional, can be null.
 *   <li>rawExpression - JSON expression snapshot to compile
 * </ul>
 *
