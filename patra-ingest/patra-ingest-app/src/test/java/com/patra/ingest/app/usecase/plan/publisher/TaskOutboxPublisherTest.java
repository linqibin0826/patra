 ...
 *
 * <p>Tests business-specific extension point implementations and adapter methods.
 *
 * @author linqibin
 * @since 0.1.0
 */
...
class TaskOutboxPublisherTest {
  ...
  void shouldNotIncludeSliceIdInPayload_whenNull() throws Exception {
    ...
    TaskQueuedEvent event =
        TaskQueuedEvent.of(
            1L, 1L, null, schedule.getId(), "PUBMED", "HARVEST", "idempotent-1", null, null, null);
  ...
  void shouldNotIncludeSchedulerJobIdInHeaders_whenNull() throws Exception {
    // given
    ScheduleInstanceAggregate scheduleWithoutJobId =
  ...
  void shouldUseOperationAsPartitionKey_whenProvenanceIsEmpty() {
    ...
    TaskQueuedEvent event =
        TaskQueuedEvent.of(
            1L, 1L, null, schedule.getId(), "", "HARVEST", "idempotent-1", null, null, null);
  ...
  void shouldUseProvenanceAsPartitionKey_whenOperationIsEmpty() {
    ...
    TaskQueuedEvent event =
        TaskQueuedEvent.of(
            1L, 1L, null, schedule.getId(), "PUBMED", "", "idempotent-1", null, null, null);
  ...
  void shouldUseTaskAsPartitionKey_whenBothAreEmpty() {
    ...
    TaskQueuedEvent event =
        TaskQueuedEvent.of(
            1L, 1L, null, schedule.getId(), "", "", "idempotent-1", null, null, null);
  ...
  void shouldHandleNullProvenanceAndOperation() {
    ...
    TaskQueuedEvent event =
        TaskQueuedEvent.of(
            1L, 1L, null, schedule.getId(), null, null, "idempotent-1", null, null, null);
