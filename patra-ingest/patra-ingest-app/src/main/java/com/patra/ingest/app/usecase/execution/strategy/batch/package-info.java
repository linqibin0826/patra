 ...
 *       - PubMed 批次生成策略（支持 History Server）
 ...
 *
 * <ol>
 *   <li>实现 {@link com.patra.ingest.domain.strategy.BatchGenerationStrategy} 接口
 *   <li>使用 {@code @Component} 注解标记为 Spring Bean
 *   <li>实现 {@code getSupportedType()} 返回对应的 PlanMetadata 类型
 *   <li>实现 {@code generateBatches()} 方法生成批次
 * </ol>
 *
 * <h2>示例</h2>
 *
