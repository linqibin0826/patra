package com.patra.ingest.app.planning.application;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ObjectUtil;
import com.patra.common.enums.ProvenanceCode;
import com.patra.ingest.app.planning.application.support.PlanExpressionBuilder;
import com.patra.ingest.app.planning.assembly.PlanAssemblyRequest;
import com.patra.ingest.app.planning.assembly.PlanAssemblyService;
...
public class PlanIngestionApplicationService implements PlanIngestionUseCase {
    ...
    private PlanAssembly assemblePlan(PlanAssemblyRequest assemblyRequest) {
        ...
        try {
            assembly = planAssemblyService.assemble(assemblyRequest);
     ...
     */
    private ScheduleInstanceAggregate persistScheduleInstanceSafely(PlanIngestionRequest request) {
