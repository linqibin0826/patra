...
///             log.info("Task execution completed: taskId={", payload.getTaskId()); catch
// (TaskAlreadySucceededException e) {
///             log.warn("Task already completed (idempotent skip): taskId={", payload.getTaskId());
// catch (LeaseAcquisitionFailedException e) {
///             log.warn("Lease acquisition failed (concurrent execution): taskId={",
// payload.getTaskId()); catch (Exception e) {
