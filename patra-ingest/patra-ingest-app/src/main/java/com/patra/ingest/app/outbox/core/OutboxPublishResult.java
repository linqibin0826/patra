 ...
 * <p>Encapsulates success/failure counts, error details, and duration metrics.</p>
 *
 * @author linqibin
 * @since 0.1.0
 */
public final class OutboxPublishResult {
    ...
    private OutboxPublishResult(int successCount, int failureCount, List<FailureDetail> failures, Duration duration) {
     ...
     */
    public static OutboxPublishResult partial(int successCount, List<FailureDetail> failures, Duration duration) {
    ...
    public String toString() {
        return String.format("OutboxPublishResult{success=%d, failure=%d, duration=%dms}",
