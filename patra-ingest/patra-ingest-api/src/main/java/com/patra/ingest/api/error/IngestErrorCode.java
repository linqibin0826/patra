 ...
 *
 * <p>All codes follow the {@code ING-NNNN} convention (ING context prefix). The 0xxx range is
 * reserved for HTTP-aligned errors via {@code HttpStdErrors.of("ING").*}; business-specific errors
 * reside in the 1xxx range.
 */
