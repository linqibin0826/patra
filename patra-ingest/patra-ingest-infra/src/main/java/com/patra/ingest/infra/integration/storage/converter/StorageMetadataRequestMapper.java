package com.patra.ingest.infra.integration.storage.converter;

import com.patra.ingest.domain.port.StorageMetadataPort.MetadataRequest;
...
public interface StorageMetadataRequestMapper {
