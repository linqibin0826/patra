 ...
 * Notes:
 * <ul>
 *   <li>Extends {@link BaseMapper} and provides basic CRUD.</li>
 *   <li>Add custom queries (e.g., by window/status) as needed with proper Javadoc.</li>
 *   <li>Data-access only; do not embed domain logic. Let repository layer coordinate complex operations.</li>
 * </ul>
 * </p>
 */
@Mapper
