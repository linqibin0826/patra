 ...
 * <p>职责：
 * <ul>
 *   <li>增量游标插入 / 更新（含规范化 instant/numeric）。</li>
 *   <li>按（provenance, operation, key, scope, namespace）组合键查找。</li>
 *   <li>查询特定来源/操作的全局时间型游标最新水位（监控 / 回放起点）。</li>
 * </ul>
 * </p>
 * <p>设计：更新后立即 selectById 以获取数据库派生字段（如 normalizedInstant）。</p>
 * <p>日志策略：DEBUG 输出 insert/update 关键标识；不打印查询日志。</p>
 */
@Repository
