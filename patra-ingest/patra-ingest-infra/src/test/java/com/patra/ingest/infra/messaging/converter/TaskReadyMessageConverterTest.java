...
/**
 * {@link TaskReadyMessageConverter} 的单元测试。
 *
 * @author linqibin
 * @since 0.1.0
 */
class TaskReadyMessageConverterTest {
    ...
    void convertPayloadAndOptionalHeader() {
        ...
        TaskReadyMessage mapped = mapper.convert(msg);
        ...
        TaskReadyMessage mapped2 = mapper.convert(msg2);
    ...
    void invalidJsonShouldThrow() {
        ...
        assertThrows(OutboxRelayExecutionException.class, () -> mapper.convert(msg));
    }
}
