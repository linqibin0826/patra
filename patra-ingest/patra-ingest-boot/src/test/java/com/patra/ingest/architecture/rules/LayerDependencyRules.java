...
public final class LayerDependencyRules {
  ...
  ///   - 反向依赖会导致循环依赖
  ///
  /// **注意：**使用精确的包名（..ingest.boot..）避免匹配 Spring Boot 框架包。
  ...
  /// 检测包之间的循环依赖，例如：
  ///
  /// - com.patra.ingest.app.usecase → com.patra.ingest.app.outbox → com.patra.ingest.app.usecase
  ///   - com.patra.ingest.domain.model → com.patra.ingest.domain.port →
