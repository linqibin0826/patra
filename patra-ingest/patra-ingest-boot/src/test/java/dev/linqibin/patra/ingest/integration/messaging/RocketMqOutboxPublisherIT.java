package dev.linqibin.patra.ingest.integration.messaging;
...
class RocketMqOutboxPublisherIT {
  ...
  /// 测试用消息收集器（仅用于本集成测试）。
  ///
  /// 继承 {@link dev.linqibin.patra.ingest.testutil.RocketMQMessageCollector}，配合 Spring 管理的
  ...
  static class MessageCollector extends dev.linqibin.patra.ingest.testutil.RocketMQMessageCollector
