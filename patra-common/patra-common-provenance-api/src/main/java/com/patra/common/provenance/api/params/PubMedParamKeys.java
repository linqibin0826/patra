 ...
 *
 * <p>集中定义所有 PubMed API 参数名称，供请求组装器和参数映射使用。
 *
 * <h3>参数分类</h3>
 *
 * <ul>
 *   <li><b>基础参数</b> - DB, ID
 *   <li><b>分页参数</b> - RETSTART, RETMAX
 *   <li><b>格式参数</b> - RETMODE, RETTYPE
 *   <li><b>查询参数</b> - TERM, SORT, DATETYPE, MINDATE, MAXDATE, FIELD, RELDATE
 *   <li><b>历史参数</b> - USEHISTORY, WEBENV, QUERY_KEY
 *   <li><b>身份参数</b> - API_KEY, TOOL, EMAIL
 * </ul>
 *
 * @author linqibin
 * @since 0.1.0
