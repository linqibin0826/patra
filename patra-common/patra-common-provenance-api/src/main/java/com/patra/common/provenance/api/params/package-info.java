 ...
 *
 * <ul>
 *   <li>{@link com.patra.common.provenance.api.params.PubMedParamKeys} - PubMed E-utilities 参数键（retstart/retmax、WebEnv/query_key）
 *   <li>{@link com.patra.common.provenance.api.params.EpmcParamKeys} - Europe PMC 参数键（pageSize/cursorMark）
 *   <li>{@link com.patra.common.provenance.api.params.CrossrefParamKeys} - Crossref Works API 参数键（offset/rows、cursor）
 *   <li>{@link com.patra.common.provenance.api.params.DoajParamKeys} - DOAJ 参数键（page/pageSize）
 * </ul>
 *
 * <h2>使用示例</h2>
 *
 ...
 * <h2>架构定位</h2>
 *
 * <p><strong>设计原则</strong>：单一事实来源（SSOT）
 *
 * <ul>
 *   <li><strong>集中管理</strong>: 所有数据源的参数键名集中定义
 *   <li><strong>类型安全</strong>: 使用常量替代魔法字符串
 *   <li><strong>跨模块共享</strong>: 供 starter-provenance、ingest、测试模块使用
 * </ul>
 *
 * @author linqibin
 * @since 0.1.0
