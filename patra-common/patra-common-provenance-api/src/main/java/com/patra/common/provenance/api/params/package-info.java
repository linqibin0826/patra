...
/// ## 核心组件
/// 
/// - {@link com.patra.common.provenance.api.params.PubMedParamKeys} - PubMed E-utilities 参数键（retstart/retmax、WebEnv/query_key）
///   - {@link com.patra.common.provenance.api.params.EpmcParamKeys} - Europe PMC 参数键（pageSize/cursorMark）
///   - {@link com.patra.common.provenance.api.params.CrossrefParamKeys} - Crossref Works API 参数键（offset/rows、cursor）
