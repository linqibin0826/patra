...
class EnumsTest {
  ...
  void ingestDateType_fromCode_and_toCode() {
    ...
    assertThatThrownBy(() -> IngestDateType.fromCode("xx"))
  ...
  void provenanceCode_parse_alias_and_json() {
    ...
    assertThatThrownBy(() -> ProvenanceCode.parse(null))
        .isInstanceOf(IllegalArgumentException.class);
    assertThatThrownBy(() -> ProvenanceCode.parse("unknownSource"))
        .isInstanceOf(IllegalArgumentException.class);
  }
  ...
  void registryConfigScope_fromCode_and_code() {
    ...
    assertThatThrownBy(() -> RegistryConfigScope.fromCode("  "))
        .isInstanceOf(IllegalArgumentException.class);
    assertThatThrownBy(() -> RegistryConfigScope.fromCode("bad"))
        .isInstanceOf(IllegalArgumentException.class);
  }
