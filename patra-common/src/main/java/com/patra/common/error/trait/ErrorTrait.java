...
/**
 * Semantic classification traits for exceptions to enable consistent error handling across
 * different exception types. These traits are used by the error resolution algorithm to map
 * exceptions to appropriate HTTP status codes and error responses.
 *
 * @author linqibin
 * @since 0.1.0
 */
