# patra-object-storage-domain — 领域层

## 概述

**patra-object-storage-domain** 是 patra-object-storage 服务的核心领域层,包含业务逻辑的核心抽象:聚合根、值对象、领域事件和仓储端口接口。
...
- **patra-object-storage-app**: 应用层用例编排器
- **patra-object-storage-infra**: 基础设施层仓储实现
- **patra-object-storage-adapter**: 适配器层(间接依赖)
...
- **应用层用例**: 参见 `patra-object-storage-app/README.md`
- **基础设施实现**: 参见 `patra-object-storage-infra/README.md`
