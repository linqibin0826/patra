 ...
 *
 * <p>执行发生在渲染器阶段,在模板展开之前。函数通过其代码标识,并通过渲染规则中的 {@code fn_code} 应用。
 *
 * <p>示例:{@code PUBMED_DATETYPE} 根据上下文返回 "pdat" 或 "edat"。
 *
...
public interface RenderFunction {
  ...
  /**
   * 返回唯一的函数代码标识符。此代码在渲染规则的 {@code fn_code} 字段中引用。
   *
