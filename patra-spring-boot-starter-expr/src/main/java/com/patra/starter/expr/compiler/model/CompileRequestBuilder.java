...
public class CompileRequestBuilder {
    ...
    /**
     * Sets the operation type dimension (e.g. {@link OperationTypes#HARVEST}, {@link OperationTypes#UPDATE}).
     *
     * @param operationType upper-case operation type; {@code null} falls back to provenance-level defaults
     * @return this builder
     */
