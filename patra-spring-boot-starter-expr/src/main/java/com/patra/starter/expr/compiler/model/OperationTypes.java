 ...
 *
 * <p>Operation types differentiate configuration slices for the same provenance in different
...
public final class OperationTypes {
     ...
     * <p>This is the most common operation type and often uses aggressive parameters to capture fresh content.</p>
     */
    public static final String UPDATE = "UPDATE";

    /**
     * Full synchronization covering the complete dataset.
     * <p>Often used for initialization or periodic refreshes that require special handling for large data volumes.</p>
     */
    public static final String FULL = "FULL";

    /**
     * Interactive search scenarios.
     * <p>Usually optimized for latency and may rely on different timeout or retry policies.</p>
     */
