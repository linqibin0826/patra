 ...
 *
 * <p>Endpoint names are used to identify different API operation types, and the system selects
...
public final class EndpointNames {
   ...
   *
   * <p>This is the most commonly used operation type, typically returning an ID list or paginated
   * results.
   */
   ...
   *
   * <p>Usually requires providing a record ID and returns detailed metadata information.
   */
   ...
   *
   * <p>Similar to SEARCH, but may return fewer fields or a different format.
   */
   ...
   *
   * <p>Only returns count information, not actual record data.
   */
   ...
   *
   * <p>Some APIs use FETCH instead of DETAIL to represent detail retrieval.
   */
