...
class DefaultExprNormalizerTest {
    ...
    void normalize_shouldTrimTermValue() {
        ...
        com.patra.expr.Atom.TermValue value = (com.patra.expr.Atom.TermValue) ((com.patra.expr.Atom) normalized).value();
    ...
    void normalize_shouldShortCircuitOrWithTrue() {
        Expr expr = Exprs.or(List.of(Exprs.constFalse(), Exprs.constTrue(), Exprs.term("a", "x", TextMatch.PHRASE)));
        Expr normalized = normalizer.normalize(expr, false);
